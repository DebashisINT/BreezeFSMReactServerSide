...
namespace BusinessLogicLayer.SalesmanTrack
{
    public class Dashboard
    {
        ...
        public DataTable GetSalesManVisitDetails(string empcode, int userid)
        {
            //int i = 0;
            //DataTable ds = new DataTable();
            ...
            DataTable ds = new DataTable();
            // ProcedureExecute proc = new ProcedureExecute("prc_FSMDashboardData");
            sqlcmd = new SqlCommand("prc_DashboardShopDetails", sqlcon);
            ...
            sqlcmd.Parameters.AddWithValue("@Action", "ShopDetails");
            ...
            //sqlcmd.Parameters.AddWithValue("@user_id", Convert.ToString(HttpContext.Current.Session["userid"]));
            sqlcmd.Parameters.AddWithValue("@user_id", Convert.ToString(userid));
            ...
            // End of Mantis Issue 25468
        {
           ...
           // proc.AddPara("@branchid", branchid);
            ...
            sqlcmd.Parameters.AddWithValue("@Action", "TODAYDATA");
            sqlcmd.Parameters.AddWithValue("@ToDate", DateTime.Now.ToString("yyyy-MM-dd"));
            sqlcmd.Parameters.AddWithValue("@Fromdate", DateTime.Now.ToString("yyyy-MM-dd"));
