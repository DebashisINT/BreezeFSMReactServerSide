...
export default function EmployeeOnLeaveGrid() {
       ...
       // }, []);
       useEffect(() => {
         axios.post('http://localhost:5738/DashboardMenu/DashboardGridView?branchid=1,118,119,120,121,122,123,124,125,127,128&stateid=15,3,35,1,24,19,16,2,28,8&FilterName=ON_LEAVE&Type=Attendance&userid=378')
